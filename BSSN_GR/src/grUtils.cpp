    ...
    void initialDataFunctionWrapper(const double xx_grid, const double yy_grid,
        ...
        switch (bssn::BSSN_ID_TYPE) {
            ...
            case 9:
                ...
                break;
            case 11:
                bssn::Bin_KerrData(xx_grid, yy_grid,zz_grid, var);
...
#include "init_data_helpers/NLTeuk_vars.cpp"
#include "init_data_helpers/Bin_Kerr.cpp"
        ...
        if (bssn::BSSN_USE_WAVELET_TOL_FUNCTION == 1) {
		    ...
		    if(T_CURRENT - bssn::TEUK_WIDTH < bssn::TEUK_R_0){
                if (r >= bssn::TEUK_R_0 + bssn::TEUK_WIDTH-T_CURRENT){
                    const double W_RR = bssn::BSSN_WAVELET_TOL_MAX;
                    double WTOL_EXP_FAC =(r-bssn::TEUK_WIDTH-bssn::TEUK_R_0+T_CURRENT)/std::log10(W_RR/bssn::BSSN_WAVELET_TOL);
                    return std::min(bssn::BSSN_WAVELET_TOL_MAX, ((std::pow(10,WTOL_EXP_FAC)) * bssn::BSSN_WAVELET_TOL) ); 
                }
                ...
                const double W_RR = bssn::BSSN_WAVELET_TOL_MAX;
            	double WTOL_EXP_FAC =(r)/std::log10(W_RR/bssn::BSSN_WAVELET_TOL);
                return std::min(bssn::BSSN_WAVELET_TOL_MAX, ((std::pow(10,WTOL_EXP_FAC)) * bssn::BSSN_WAVELET_TOL) );     
            }
        } else {
            return bssn::BSSN_WAVELET_TOL;
